...
#define HOMING_BUMP_MM      { 0, 0, 6 }       // (linear=mm, rotational=°) Backoff from endstops after first bump
...
#define Z_STEPPER_AUTO_ALIGN
   ...
   */
  #define Z_STEPPER_ALIGN_XY { {  25, (Y_BED_SIZE) / 3 }, { (X_BED_SIZE) - 25, (Y_BED_SIZE) / 3 } }

...
#define STRING_CONFIG_H_AUTHOR "Jacob Jordan" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 400, 280 } // Z and E0 are for 32x microstepping!
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT ((X_BED_SIZE) / 4)  // X point for Z homing
  #define Z_SAFE_HOMING_Y_POINT ((Y_BED_SIZE) / 3)  // Y point for Z homing
#endif

// Homing speeds (mm/min)
#define HOMING_FEEDRATE_MM_M { 3000, 3000, Z_PROBE_FEEDRATE_FAST }
...
#define SKEW_CORRECTION
  ...
  #define XY_DIAG_AC 141.53
  #define XY_DIAG_BD 141.32
